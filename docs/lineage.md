...
| Retrieval | `scripts/retrieve_public_aggregates.py`, `scripts/retrieve_public_conversion_model.py` | Dry run first; explicit billing project; 4 GB cap per query | Query/job hashes in `data/observed/ga4_public_sample/retrieval_metadata.json` |
